            ...
            <form action="{{ route('product.update', $product->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <select name="id_toko" id=""
                        ...
                        @foreach ($toko as $a)
                            <option value="{{ $a->id }}" {{ old('id_toko', $product->id_toko) == $a->id ? 'selected' : '' }}>
                                {{ $a->nama_toko }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="nama_produk" value="{{ old('nama_produk', $product->nama_produk)}}" required>
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="harga" value="{{ old('harga', $product->harga)}}" required>
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="stok" value="{{ old('stok', $product->stok)}}" required>
