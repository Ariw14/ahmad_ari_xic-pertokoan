            ...
            <form action="{{ route('toko.update', $toko->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        ...
                        name="nama_toko" value="{{ old('nama_toko', $toko->nama_toko)}}" required>
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="alamat"  value="{{ old('alamat', $toko->alamat)}}" required>
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="nomor_telepon" value="{{ old('nomor_telepon', $toko->nomor_telepon)}}" required>
